...
const courses: Course[] = [
  ...
  { code: "STHS", name: "Sewing Machine Processes", initial: 4, refresher: 3, adjustment: 0, group: "Textile Technology (STHS)" },
  { code: "STHS", name: "Textiles Heat Processes", initial: 2, refresher: 1, adjustment: 0, group: "Textile Technology (STHS)" },
