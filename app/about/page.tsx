    ...
    <main>
      ...
      <section className="about-story content-section">
        ...
        <div>
          ...
          <a className="section-link" href="https://www.designtechnology.org.uk/organisation/member-directory/24861" target="_blank" rel="noreferrer">Verify Simon on the D&amp;TA consultant directory <span>↗</span></a>
        </div>
      </section>
